...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        Tournament2.test(red="../src/agent_hard_coded_v4.py", blue="domination/agent.py")
    else:
...
# Initialize a game
#game = core.Game('domination/agent.py','domination/agent.py', record=True, rendered=True, settings=settings, red_init={'blob': open('../src/agent_test_blob','rb')}, field=core.Field.from_string(FIELD2))
